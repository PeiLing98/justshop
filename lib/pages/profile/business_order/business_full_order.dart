                          ...
                          builder: (context, snapshot) {
                            if (snapshot.hasData) {
                              ...
                              matchedChat = chat?.where((chat) {
                                return chat.user1 == widget.order.userId &&
                                                                            ...
                                                                            children: [
                                                                              Padding(
                                                                                ...
                                                                                child: Row(children: [
                                                                                  ...
                                                                                  Text(
                                                                                    matchedOrderItem[index]['order']['orderStatus'] == 'To Ship'
                                                                                        ? 'New Order!'
                                                                                        : matchedOrderItem[index]['order']['orderStatus'] == 'Preparing'
                                                                                            ? 'Preparing'
                                                                                          ...
                                                                                          Row(
                                                                                            ...
                                                                                            children: [
                                                                                              ...
                                                                                              Row(
                                                                                                ...
                                                                                                children: [
                                                                                                  Text(
                                                                                                    'Subtotal: RM' + (double.parse(matchedItem[index].price == "" ? '0' : matchedItem[index].price) * matchedOrderItem[index]['order']["quantity"]).toStringAsFixed(2),
                                                                                                    style: priceLabelStyle,
                                                                                                  )
                                                                                                ],
                                                                                              ),
                                                                              ...
                                                                              ProfileTextField(
                                                                                textFieldLabel: "Remark / Special Request",
                                                                                textFieldValue: matchedOrderItem[index]['order']['request'],
                                                                                textFieldLine: 3,
                                                                                textFieldHeight: 50,
                                                                                isReadOnly: true,
                                                                                isBold: true,
                                                                                      ...
                                                                                      child: PurpleTextButton(
                                                                                        ...
                                                                                        onClick: () {
                                                                                          if (matchedChat!.isEmpty) {
                                                                                            Chat newChat = Chat(chatId: "", user1: widget.order.userId, user2: store.storeId, message: []);
                                                                                      ...
                                                                                      child: PurpleTextButton(
                                                                                        ...
                                                                                        onClick: () {
                                                                                          showDialog(
                                                                                              context: context,
                                                                                              builder: (context) {
                                                                                                return OrderStatusModal(preparingOnClick: () async {
                                                                                                  setState(() {
